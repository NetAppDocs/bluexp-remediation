...
* When creating a Cloud Volumes ONTAP volume template, make sure you have a Cloud Volumes ONTAP working environment available for your users. See how to launch a Cloud Volumes ONTAP system in https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-aws.html[AWS^], https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-azure.html[Azure^], or in https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-gcp.html[GCP^].

* When creating an on-premises ONTAP volume template, make sure you have an on-premises ONTAP working environment available for your users. See how to https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-discovering-ontap.html[discover an on-premises ONTAP system^] in BlueXP.

* When creating an Azure NetApp Files volume template, make sure you have an Azure NetApp Files working environment available for your users. See how to https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-quick-start.html[create an Azure NetApp Files working environment^] in BlueXP.
...
See https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-create-volumes.html#create-volumes[how to provision Azure NetApp Files volumes^] for details about all the parameters you need to complete in the ANF volume template.
...
See https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-manage-ontap-connector.html#create-volumes[how to provision on-premises ONTAP volumes^] for details about all the parameters you need to complete in the on-premises ONTAP volume template.
...
. *Location & Connectivity*: Enter the network information that you recorded in the https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-planning-your-config.html#collect-networking-information[AWS worksheet^]. This includes the AWS Region, VPC, Subnet, and Security Group.
+
...
+
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-set-up-licensing-aws.html[Learn about these charging methods^].
...
When creating a volume template, you can add in the template that you want to create backups of the volume periodically using the https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-ontap-backup-to-cloud.html[BlueXP backup and recovery^] service.
...
When creating a volume template, you can add in the template that you want to scan the volume for compliance and classification using the https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html[BlueXP classification^] service.
