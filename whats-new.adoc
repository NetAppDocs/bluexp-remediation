...
Current support is for volumes on Cloud Volumes ONTAP and on-premises ONTAP systems. https://docs.netapp.com/us-en/cloud-manager-app-template/task-define-templates.html#find-existing-volumes-and-activate-bluexp-backup-and-recovery[Go here for details].
