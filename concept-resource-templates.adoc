...
* Activate https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-ontap-backup-to-cloud.html[BlueXP backup and recovery^] on volumes (not applicable for Azure NetApp Files)
* Activate https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html[BlueXP classification^] on volumes
* Activate https://docs.netapp.com/us-en/cloud-manager-replication/concept-replication.html[BlueXP replication^] on volumes (not applicable for Azure NetApp Files)
